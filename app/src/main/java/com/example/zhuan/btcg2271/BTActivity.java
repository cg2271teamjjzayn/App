package com.example.zhuan.btcg2271;
...
public class BTActivity extends AppCompatActivity {
    ...
    public final String TAG = "BTActivity";

    //Joystick data views
    private TextView pwmData;
    private TextView strengthData;

    //UI for Bluetooth modules
...
//    private BluetoothSPP bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pwmData = findViewById(R.id.pwmData);
        strengthData = findViewById(R.id.strengthData);
...
//                btCom.start();
//                btCom.connectDevice("HC-06");
//                status.setText("Connected");
//            } else {
//                status.setText("Bluetooth Not enabled");
//            }
//        } catch(Exception e){
//            status.setText("Unable to connect to " +e);
//        }
//    }
}
